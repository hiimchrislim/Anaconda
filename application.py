...
class Application:
    ...
    window_size: size of the GUI window
    food_size: size of the food the snake eats
    snakeH_size: size of the snake's head
    snakeT_size: size of the snake's tail
    clock: manage how fast the screen refreshes (FPS)
    grid_width: width of each grid
    grid_height: height of each grid
    margin: space between each grid
    """
    ...
    def show_title_screen(self) -> None:
        ...
        while intro:
            ...
            self.screen.blit(title, (self.window_size[0] // 5.6, self.window_size[1] // 5))
    ...
    def show_rules_screen(self):
        ...
        while show_rules:
            ...
            if (269 <= mouse_pos[0] <= 321) and (537 <= mouse_pos[1] <= 555):
                rules_text_highlight = rules_render.render("Back", 1, self.brown)
                self.screen.blit(rules_text_highlight,
    ...
    def play(self) -> None:
        ...
        while not game_over:
            ...
            self.clock.tick(2)  # Limit to 60 frames per second
    ...
    def restart_game(self):
        ...
        while restart:
            ...
            game_over_label = game_over_render.render("Game Over!", 1, self.white)
